package by.fpmi.bsu.pianolane.synthesizer.oscillator;


import static by.fpmi.bsu.pianolane.common.ui.ElementsFactory.createKnobWithLabel;
...
public class OscillatorController {
    ...
    private void redrawWaveform() {
        ...
        for (int x = 0; x < width; x++) {
            ...
            float amplitude = SoundUtil.generateWaveform(settings.getWaveform(), normalizedPhase) * 0.8f;
