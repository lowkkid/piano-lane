...
import static by.fpmi.bsu.pianolane.util.enums.FilterType.BAND_PASS;
import static by.fpmi.bsu.synthesizer.ui.ElementsFactory.createKnobWithLabel;

import by.fpmi.bsu.pianolane.util.enums.FilterType;
import by.fpmi.bsu.synthesizer.settings.FilterSettings;
...
public class FilterController {
    ...
    @FXML private FilterSettings filterSettings = new FilterSettings();
    ...
    public void initialize() {
        ...
        filterTypeChoiceBox.getSelectionModel().selectFirst();
    ...
    private void initializeControls() {
        VBox frequencyKnob = createKnobWithLabel(
                20,
                Color.WHITE,
                "FREQUENCY",
        ...
        VBox resonanceKnob = createKnobWithLabel(
                20,
                Color.WHITE,
                "RESONANCE",
                filterSettings.getQ(),
