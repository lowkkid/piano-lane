...
public class SynthTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Добавляем аккорд C мажор: C4, E4, G4
        activeVoices.add(new Voice(261.1, 0.8f, Waveform.TRIANGLE, SAMPLE_RATE)); // C
        //activeVoices.add(new Voice(329.63, 0.8f, Waveform.SINE, SAMPLE_RATE)); // E
        activeVoices.add(new Voice(392.00, 0.8f, Waveform.TRIANGLE, SAMPLE_RATE)); // G
        ...
        dispatcher.addAudioProcessor(new AudioProcessor() {
            ...
            public boolean process(AudioEvent event) {
                ...
                // Останавливаем dispatcher, если все голоса завершены
